...
VENV_PY=/home/f25-echo2/echo_fsw/venv/bin/python
if [[ ! -x "$VENV_PY" ]]; then
  echo "ERROR: venv python not found at $VENV_PY" >&2
  echo "The service files reference this path. Either:" >&2
  echo "  (a) create the venv:  sudo -u f25-echo2 python3 -m venv /home/f25-echo2/echo_fsw/venv" >&2
  echo "      then install deps: sudo -u f25-echo2 /home/f25-echo2/echo_fsw/venv/bin/pip install ..." >&2
